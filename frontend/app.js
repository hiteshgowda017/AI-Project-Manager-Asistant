const App = (() => {
  ...
  const actions = {
    ...
    async initDashboard() {
      ...
      if (state.workspaces[0]) {
        actions.selectWorkspace(state.workspaces[0]);
      }
      bindEvents();
    ...
    async updateApiStatus() {
      ...
      try {
        await api.health();
        elements.apiStatusInline.querySelector("span:last-child").textContent =
          "API: Online";
        elements.apiStatusInline.querySelector(".dot").style.background =
          "var(--sea-500)";
      } catch (error) {
        elements.apiStatusInline.querySelector("span:last-child").textContent =
          "API: Offline";
  ...
  function bindEvents() {
    document
      .getElementById("createWorkspaceButton")
      .addEventListener("click", () => {
        elements.workspaceForm.hidden = false;
      });
    document
      .getElementById("cancelWorkspaceButton")
      .addEventListener("click", () => {
        elements.workspaceForm.hidden = true;
      });
    document
      .getElementById("saveWorkspaceButton")
    ...
    document
      .getElementById("refreshInsightsButton")
      .addEventListener("click", async () => {
    ...
    document
      .getElementById("loadHealthButton")
      .addEventListener("click", async () => {
    ...
    document
      .getElementById("generateTasksButton")
      .addEventListener("click", async () => {
    ...
    document
      .getElementById("commitTasksButton")
      .addEventListener("click", async () => {
    ...
    document
      .getElementById("askDecisionButton")
      .addEventListener("click", async () => {
